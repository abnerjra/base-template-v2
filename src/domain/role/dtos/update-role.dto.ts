...
export class UpdateRoleDto {
    ...
    static create(props: { [key: string]: any }): ResponseEntity | UpdateRoleDto {
        let validateMessage: string[] = [];

        const { id, name, description, key, active, modules } = props;
        ...
        return new UpdateRoleDto(idNumber, name, description, key, modules, activeBoolean);
    }
}